...
namespace FileParserNetStandard_Tests {
    ...
    public class Tests {
        ...
        private string _csvPath = "/Users/richard/dev/Dip-Seminar-Delegates-Lambda-Linq_Exercises/Files/data.csv";  // change to appropriate path
        
        private string _tsvPath = "/Users/richard/dev/Dip-Seminar-Delegates-Lambda-Linq_Exercises/Files/data.tsv";  // change to appropriate path

        private string _writeFile = "/Users/richard/dev/Dip-Seminar-Delegates-Lambda-Linq_Exercises/Files/dataWrite.txt";  // change to appropriate path
